...
public class Quiz { // Aqui ficam as perguntas e o tratamento das respostas
	...
	public void resultadoFinal(Jogador jogador1, Jogador jogador2){
		System.out.println("------------------------------------------------------------------");
	...
	public void perguntaFacil1(Jogador jogador) {
		System.out.println("------------------------------------------------------------------");
	...
	public void perguntaFacil2(Jogador jogador) {
		System.out.println("------------------------------------------------------------------");
		System.out.println("Vez do Jogador " + jogador.getNickname() + "(Pergunta nível fácil)");
	...
	public void perguntaFacil3(Jogador jogador) {
		System.out.println("------------------------------------------------------------------");
	...
	public void perguntaFacil4(Jogador jogador) {
		System.out.println("------------------------------------------------------------------");
		System.out.println("Vez do Jogador " + jogador.getNickname() + "\n" + "Pergunta nível fácil" + "\n");
	...
	public void perguntaMedia1(Jogador jogador){
		System.out.println("------------------------------------------------------------------");
	...
	public void perguntaMedia2(Jogador jogador){
		System.out.println("------------------------------------------------------------------");
		System.out.println("Vez do Jogador " + jogador.getNickname() + "\n" + "Pergunta nível médio" + "\n");
	...
	public void perguntaMedia3(Jogador jogador){
		System.out.println("------------------------------------------------------------------");
		System.out.println("Vez do Jogador " + jogador.getNickname() + "\n" + "Pergunta nível médio" + "\n");
	...
	public void perguntaMedia4(Jogador jogador){
		System.out.println("------------------------------------------------------------------");
		System.out.println("Vez do Jogador " + jogador.getNickname() + "\n" + "Pergunta nível médio" + "\n");
	...
	public void perguntaDificil1(Jogador jogador){
		System.out.println("------------------------------------------------------------------");
	...
	public void perguntaDificil2(Jogador jogador){
		System.out.println("------------------------------------------------------------------");
		System.out.println("Vez do Jogador " + jogador.getNickname() + "\n" + "Pergunta nível difícil" + "\n");
